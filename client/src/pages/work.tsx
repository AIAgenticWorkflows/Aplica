        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <FadeIn delay={0.1}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Market Analysis</Badge>
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Price Prediction</Badge>
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Location Insights</Badge>
              </div>
          ...
          <FadeIn delay={0.2}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Price Tracking</Badge>
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Preference Learning</Badge>
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Deal Discovery</Badge>
              </div>
              <div className="text-sm text-secondary">
          ...
          <FadeIn delay={0.3}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Route Optimization</Badge>
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Local Insights</Badge>
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Dynamic Planning</Badge>
              </div>
              <div className="text-sm text-secondary">
          ...
          <FadeIn delay={0.4}>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Professional Matching</Badge>
                <Badge variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">Quality Scoring</Badge>
                <Badge variant="secondary" className="bg-accent/10 text-accent hover:bg-accent/20">Availability Sync</Badge>
              </div>
              <div className="text-sm text-secondary">
