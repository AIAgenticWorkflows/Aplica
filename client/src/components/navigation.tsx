      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-28">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="md:hidden text-white hover:text-purple-200 hover:bg-purple-600"
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-purple-700 border-t border-purple-800">
            <div className="px-4 py-2 space-y-2">
              {navItems.map((item) => (
                <Link
                  key={item.path}
                  href={item.path}
                  className="block py-2 text-purple-200 hover:text-white transition-colors duration-200"
